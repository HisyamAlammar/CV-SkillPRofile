                ...
                <div className="animate-fade-in" style={{ textAlign: 'left', zIndex: 1 }}>
                    ...
                    <div className="hero-cta-group" style={{ display: 'flex', gap: '1rem', marginBottom: '2rem', flexWrap: 'wrap' }}>
                        ...
                        <a href={cvFile} target="_blank" rel="noopener noreferrer" className="btn glass" style={{ borderColor: 'var(--accent-color)', color: 'var(--accent-color)' }}>
                            Resume <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={{ marginLeft: '5px' }}><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"></path><polyline points="7 10 12 15 17 10"></polyline><line x1="12" y1="15" x2="12" y2="3"></line></svg>
                        </a>
                    </div>
                    ...
                    <div style={{ display: 'flex', gap: '1.5rem', alignItems: 'center' }}>
                        ...
                        <a href="https://www.linkedin.com/in/abyan-al-ammar-4b341b295" target="_blank" rel="noreferrer" style={{ color: '#aaa', transition: 'color 0.3s' }} onMouseOver={e => e.currentTarget.style.color = '#fff'} onMouseOut={e => e.currentTarget.style.color = '#aaa'}>
